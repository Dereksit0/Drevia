...
const casos: Caso[] = [
  ...
  },
  {
    ...
    title: "Landing page",
    highlight: "que convierte visitas",
    tags: ["Landing page", "Conversión", "CTAs"],
    year: "2024",
    desc: "Una sola página enfocada en un objetivo: mensaje claro, carga rápida y llamados a la acción que reducen la fricción hasta el contacto.",
    metric: "+320%",
  ...
  },
  {
    ...
    highlight: "que crece desde el día uno",
    tags: ["Tienda en línea", "Fitness", "Escala"],
    year: "2024",
